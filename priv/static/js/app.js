...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{staticClass:"brand"},[_c('div',{staticClass:"great-question"},[_c('h3',[_vm._v(_vm._s(_vm.question)),_c('span',[_vm._v("?")])]),_vm._v(" "),_c('a',{staticClass:"btn-primary",attrs:{"href":"#comment"}},[_vm._v("Comment")])]),_vm._v(" "),_c('div',{staticClass:"comment-list"},[_c('span',{directives:[{name:"show",rawName:"v-show",value:(_vm.loading),expression:"loading"}],staticClass:"spinner"}),_vm._v(" "),_c('ul',_vm._l((_vm.comments),function(comment){return _c('comment',{key:comment.id,attrs:{"comment":comment}})}))]),_vm._v(" "),_c('comment-form',{on:{"commented":_vm.updateComment}})],1)])}
...
var x = _vue2.default.use(_vueResource2.default);
console.log(x);
...
require.alias("vue-resource/dist/vue-resource.common.js", "vue-resource");process = require('process');require.register("___globals___", function(exports, require, module) {
